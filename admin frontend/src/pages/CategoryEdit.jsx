    ...
    const fetchCategory = async () => {
      try {
        ...
        if (res.data.success) {
          ...
          if (cat.image) setFileName(cat.image);
        }
      } catch (err) {
  ...
  return (
    <div className={styles.bodyWrapper}>
      <div className="d-flex">
        {/* Same Sidebar as CategoryDashboard */}
        ...
        <div className="flex-grow-1">
          <div className={`${styles.mainWrapper} me-3`}>
            ...
            {/* Same Top Navbar as CategoryDashboard */}
            <div className={`${styles.topNavbar} d-flex justify-content-between align-items-center mb-4`}>
              ...
              <div className="d-flex align-items-center gap-3">
                ...
                <div className="dropdown">
                  <a className="nav-link dropdown-toggle fw-semibold text-dark" href="#admin-menu"
            ...
            <div className="bg-white p-5 rounded-3 shadow-sm">
              <h4 className="fw-semibold mb-1">Edit Category</h4>
              <hr className="text-muted opacity-25 mb-4" />

              <form onSubmit={(e) => e.preventDefault()}>
                <div className="row mb-4">
                  <label htmlFor="name" className="col-sm-2 col-form-label fw-medium text-secondary">
                    Name
                  </label>
                ...
                <div className="row mb-4">
                  <label htmlFor="description" className="col-sm-2 col-form-label fw-medium text-secondary">
                    Description
                  </label>
                  <div className="col-sm-10">
                    <textarea
